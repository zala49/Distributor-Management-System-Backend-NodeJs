...
router.get("/getCityById", runAsyncWrapper(CityController.getCityById));
router.get("/getCityByDistributorId", runAsyncWrapper(CityController.getCityByDistributorId));
