...
export class Start1688973571621 implements MigrationInterface {
    name = 'Start1688973571621'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "users_info" ("UserId" uuid NOT NULL DEFAULT uuid_generate_v4(), "Name" character varying NOT NULL, "Email" character varying NOT NULL, "Picture" character varying, "Role" character varying, "Password" character varying NOT NULL, "CreatedAt" TIMESTAMP NOT NULL DEFAULT now(), "UpdatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_3872a2caa946ac97b7639c021b1" PRIMARY KEY ("UserId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "orders" ("OrderId" uuid NOT NULL DEFAULT uuid_generate_v4(), "ProductId" uuid NOT NULL, "MerchantId" uuid NOT NULL, "SalesmenId" uuid, "SalesMen" character varying NOT NULL, "ProductName" character varying NOT NULL, "ProductCategory" character varying NOT NULL, "ProductQuantity" character varying NOT NULL, "OrderDate" TIMESTAMP NOT NULL, "Status" character varying NOT NULL DEFAULT 'Pending', "CreatedAt" TIMESTAMP NOT NULL DEFAULT now(), "UpdatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_3963a47ebcfe4fbadb7d2b89611" UNIQUE ("ProductId", "SalesMen", "ProductQuantity"), CONSTRAINT "PK_81fe92d0102a32ecf1a4123ce8f" PRIMARY KEY ("OrderId"))`);
