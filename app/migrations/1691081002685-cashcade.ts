...
export class Cashcade1691081002685 implements MigrationInterface {
    name = 'Cashcade1691081002685'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "distributor_city" ADD CONSTRAINT "FK_c80335ce110b96d79eb0829f7f2" FOREIGN KEY ("DistributorId") REFERENCES "distibutor"("DistributorId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "merchant" ADD CONSTRAINT "FK_489234217e927ac458684fe0317" FOREIGN KEY ("DistributorId") REFERENCES "distibutor"("DistributorId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "merchant" ADD CONSTRAINT "FK_1c59d9865dd65cc3f5008358e28" FOREIGN KEY ("CityId") REFERENCES "citys"("CityId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "products_Categorys" ADD CONSTRAINT "FK_2ef844302819ca19b7a5e65bf44" FOREIGN KEY ("ProductId") REFERENCES "products"("ProductId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_9a8794c441b3b4672d07aa2cf03" FOREIGN KEY ("ProductCategoryId") REFERENCES "products_Categorys"("ProductCategoryId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_9f3a480ca0ff701eaef7e9bd4d4" FOREIGN KEY ("MerchantId") REFERENCES "merchant"("MerchantId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_b71c7354f515a09ec953001ac59" FOREIGN KEY ("DistributorId") REFERENCES "distibutor"("DistributorId") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_31f766b57ec33c631eea0ad678a" FOREIGN KEY ("SalesmenId") REFERENCES "users_info"("UserId") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
